 ...
 * @version 1.0
 * Modified by Ana Martinez Sidera and Jose Luis Martin Casarrubios 
 * 
 */
...
public class Production
{
	...
	Production(Production p)
	{
		...
		probabilityAcum=probability; //added to get the probability of the tree
		left = p.left;
		right = p.right;
		dot = p.dot;
		start = p.start;
...
/////////////////////////////////////////////////////////
private float getProbability() // Modified to get the probability of the tree
{
return probabilityAcum;}
/////////////////////////////////////////////////////////
	...
	public void recursivePrint()
	{
		...
		for(int i=0;i<right.length;i++)
		{
			if(this.children!=null)
			{
				...
				probabilityAcum=children[i].getProbability()*probabilityAcum;
			}else
			{
...
System.out.print("]");
	...
	public void probabilityAcum()	
	{
		System.out.println("\n This tree has a probability of: " + probabilityAcum);
	}
